namespace LaptopWebshop
{
    public class Laptop : Product
    {
        ...
        public override string ToString() => string.Format("ID: {0}: Name: {1}, Brand: {2}, Weight: {3} Kg, Count: {4}, Price: {5:C}\r\n\tCPU: {6}\r\n\tGPU: {7}\r\n\tRAM: {8}\r\n\tHardDrive: {9}\r\n\tScreen: {10}", id, name, brand, weight, count, price, processor.ToString(), graphicsCard.ToString(), memory.ToString(), storage.ToString(), screen.ToString());

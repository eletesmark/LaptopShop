...
namespace LaptopWebshop
{
	public static class UserStorage
	{
        ...
        public static void AddUser(User u) => users[u.username] = u;
        ...
        {
            TextWriter registeredUsers_Txt = new StreamWriter("registeredUsers.txt", false, Encoding.UTF8);
            TextWriter managers_Txt = new StreamWriter("managers.txt", false, Encoding.UTF8);
            TextWriter admins_Txt = new StreamWriter("admins.txt", false, Encoding.UTF8);
